...
const BioAI: React.FC = () => {
  ...
  const generateBio = async () => {
    ...
    try {
      ...
      Keep it under 150 words. Do not use markdown formatting, just raw text.`;
  ...
  return (
    <div className="pt-24 pb-12 px-4 max-w-4xl mx-auto min-h-screen flex flex-col items-center">
      <div className="w-full text-center mb-12">
        <h2 className="brand-font text-6xl text-white neon-text mb-4">REVALIXX <span className="text-red-600">AI</span></h2>
        <p className="text-gray-400 text-lg">Générez des descriptions percutantes pour vos réseaux sociaux avec Gemini.</p>
      </div>
      ...
      <div className="w-full bg-neutral-900/80 border border-red-900 p-8 rounded-xl backdrop-blur-sm shadow-[0_0_30px_rgba(220,38,38,0.1)]">
        ...
        <div className="mb-6">
            <label className="block text-red-500 font-bold mb-2 uppercase tracking-wider">Thème de la Bio / Track</label>
            <input 
                type="text" 
                value={promptTopic}
                onChange={(e) => setPromptTopic(e.target.value)}
                placeholder="Ex: Sortie de nouvel album, Grosse date à Berlin..."
      ...
      <div className="mt-20 w-full text-center">
        <h3 className="brand-font text-3xl mb-6 border-b border-gray-800 pb-2 inline-block">À PROPOS</h3>
        <p className="text-gray-400 max-w-2xl mx-auto leading-7">
            Revalixx est un duo de Hard Techno originaire de France. Nés dans le chaos des entrepôts désaffectés, ils apportent une sonorité industrielle brutale mêlée à des mélodies acides. Leur mission : transformer chaque dancefloor en une zone de guerre rythmique.
        </p>
      </div>
